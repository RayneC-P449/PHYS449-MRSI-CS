classdef LCMHelper
   ...
   methods
       ...
       function out = wsl_path(obj, path)
           out = strrep(path, "C:", "c");
           out = strrep(out, "\", "/");
       end
   end
